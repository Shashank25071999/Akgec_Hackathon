                    ...
                    child: Row(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Container(
                            child: Text(
                              "05",style: TextStyle(color: Color(0xffefb168),fontSize: 40),
                            ),
                          ),
                        ),
                        SizedBox(width: 4,),
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                  child:  Text("LAST DATE FOR",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 12)),
                                  )
                                ],
                              ),
                              Text("SYNOPSIS SUBMISSION",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 12)),
                            ],
                          )
                        )
                      ],
                          ...
                          child: Row(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "10",style: TextStyle(color: Color(0xffefb168),fontSize: 40),
                                  ),
                                ),
                              ),
                              SizedBox(width: 4,),
                                    ...
                                    children: <Widget>[
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                            child:  Text("NOTIFICATION",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 12)),
                                          )
                                        ],
                                      ),
                                      Text("OF ACCEPTANCE",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 12)),
                                    ],
                                  )
                              )
                            ],
                          ...
                          child: Row(
                            children: <Widget>[
                              Padding(
                                ...
                                child: Container(
                                  child: Text(
                                    "26",style: TextStyle(color: Color(0xffefb168),fontSize: 40),
                                  ),
                                ),
                              ),
                              SizedBox(width: 4,),
                              Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text("MAIN EVENT",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 12)),
                                    ],
                                  )
                              )
                            ],
