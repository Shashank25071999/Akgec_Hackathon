...
import 'package:scrolls/loginscreen/memberregistation.dart';
...
class MediatorState extends State<Mediator> {
  ...
  String scrollsId; //variable for entering textformfield scrollsid
   ...
   int dayleftnow(int d,int m)
  {
      ...
      void download()async{
        ...
        Directory dir = await getExternalStorageDirectory();
          ...
          final RegExp regex = RegExp('([^?/]*\.(pdf))');
           final String fileName = regex.stringMatch(fullurlfordownloadpdf);
          await new Directory(dir.path.toString() + "/Scrolls").create(recursive: true).then((data){
            print("file created");
          });
          print("shashank saahi");
          print(dir.path.toString());
          await dio.download("https://scrolls-backend.s3.ap-south-1.amazonaws.com/SAMPLE+SYNOPSIS.pdf", "${dir.path.toString()}" + "/Scrolls" + "${fileName}", onReceiveProgress: (rec, total) {
            // setState(() {
            //  progressindicatorvariable=true; 
            // });
              //   print("rec:${rec}");
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              content: Text("Your File is Download in Android/data/com.example.scrolls/files"),
              title: Text("Success"),
              actions: <Widget>[
                FlatButton(
                  child: Text("Okay"),
    ...
    void filepicker()async{
        ...
        filepath=await FilePicker.getFilePath(type: FileType.ANY,fileExtension: "pdf");
  ...
  Future<void> loginFunction() async {
    ...
    http.post("https://scrolls19-backend.herokuapp.com/api/authenticate",
  ...
  Widget build(BuildContext context) {
    ...
    return  logic
            ?Stack(children: <Widget>[Scaffold(//drawer: Drawer(child: Column(),),
            ...
            child: AppBar(
              ...
              centerTitle: true,
                ...
                body:  SingleChildScrollView(
                          ...
                          decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/bgapp.jpg",))),
                      child: Padding(
                                ...
                                child: Row(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    Padding(
                                      ...
                                      child: Container(height: 60,width: 50,child: Image(image: AssetImage("assets/light.gif"),)),),
                                    Padding(
                              ...
                              children: <Widget>[
                                ...
                                color: Color(0xff1f1f1f),
                                  child: Column(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>[
                                 uploadsynopsis? Container() :Container(//include the variable
                                              ...
                                              width: MediaQuery.of(context).size.width,child: Padding(
                                                ...
                                                children: <Widget>[
                                                        Icon(Icons.error,color: Color(0xff1f1f1f),),
                                                        Padding(padding: EdgeInsets.only(right:20),),
                                                        Expanded(child: Container(child: Text("You have not uploaded a synopsis yet !",style: TextStyle(color: Color(0xff1f1f1f),fontWeight: FontWeight.bold,fontSize: 14),)))
                                            ],),
                                              ),),
                                      Container(
...
child: Column(
                                              ...
                                              children: <Widget>[
                                                ...
                                                Padding(
                                                  padding: const EdgeInsets.all(10.0),
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,children: <Widget>[Text("WELCOME TEAM ",style: TextStyle(color: Color(0xffefb168),fontSize: 25,fontWeight: FontWeight.bold),),],),
                                                ),
                                                 SizedBox(height: 2,),
                                Container(height: 2,width: 250,color: Color(0xffefb168),),
                                SizedBox(height: 10,),
                                Text(team_name,style: TextStyle(color: Color(0xffffffff),fontSize: 30,fontWeight: FontWeight.bold),),SizedBox(height: 2,),
                                                SizedBox(height: 20,),
                                                Padding(
                                                  padding: EdgeInsets.all(10.0),
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: <Widget>[
                                                      Text("Name: ",style: TextStyle(color: Color(0xffefb168),fontWeight: FontWeight.bold),),
                                                      Expanded(child: Text(firstname+" "+lastname,style: TextStyle(color: Color(0xffffffff),),)),
                                                ...
                                                Padding(
                                                  ...
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: <Widget>[
                                                      Text("E-mail: ",style: TextStyle(color: Color(0xffefb168),fontWeight: FontWeight.bold),),
                                                      Expanded(child: Text(fetchemail,style: TextStyle(color: Color(0xffffffff)),)),
                                                    ],
                                                  ),
                                                ),
                                                Padding(
                                                  ...
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: <Widget>[
                                                      Text("College: ",style: TextStyle(color: Color(0xffefb168),fontWeight: FontWeight.bold),),
                                                      Expanded(child: Text(college,style: TextStyle(color: Color(0xffffffff)),)),
                                                    ],
                                                  ),
                                                ),
                                                Padding(
                                                  ...
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                    children: <Widget>[
                                                      Text("Team Name: ",style: TextStyle(color: Color(0xffefb168),fontWeight: FontWeight.bold),),
                                                      Expanded(child: Text(team_name,style: TextStyle(color: Color(0xffffffff)),)),
                                                    ],
                                                  ),
                                                ),
                                                ...
                                                child: Row(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: <Widget>[
                                                    ...
                                                    Expanded(child: Text(domainid==1?"Computer Science": domainid==2?"Mechanical": domainid==3?"Electrical": domainid==4?"ECE": domainid==5?"CIvil": "MAnage",style: TextStyle(color: Color(0xffffffff)),)),
                                                  ],
                                                ),
                                              ),
...
SizedBox(height: 20,),
                               ...
                               Container(),
                                                ...
                                                SizedBox(height: 10,),
                                                 ...
                                                 GestureDetector(onTap: (){
                                                          filepicker();
                                                      },child: Card(color: Color(0xffefb168),clipBehavior: Clip.antiAlias,child: Container(width: MediaQuery.of(context).size.width/1.5,child: Padding(
                                                        padding: const EdgeInsets.all(10.0),
                                                        child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon(Icons.markunread_mailbox,color: Color(0xff1f1f1f),),
                                                            Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                              child: Text("Choose File",style: TextStyle(color: Color(0xff1f1f1f)),),
                                                            ),
                                                          ],
                                                        ),
                                                      ))),),

                                                      filepath!=null?Padding(
                                                        padding: const EdgeInsets.all(10.0),
                                                        child: Container(
                                                         child: Text(filepath,style: TextStyle(fontSize: 10,fontStyle: FontStyle.italic,color: Colors.white),)
                                                        ),
                                                      ):Container(),
                                                       ...
                                                       Builder(
                                                              ...
                                                              builder: (context) =>GestureDetector(onTap: (){
                                                                ...
                                                                {
                                                                  _displaySnackBar(context, "Please Choose a file before uploading");
                                                                }
                                                          upload();
                                                        ...
                                                        child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon(Icons.file_upload,color: Color(0xff1f1f1f),),
                                                            Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                              child: Text("Upload",style: TextStyle(color: Color(0xff1f1f1f)),),
                                                            ),
                                                          ],
                                                        ),
                                                      ))),),),
                                                ...
                                                GestureDetector(onTap: (){
                                                        ...
                                                        child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon(Icons.file_download,color: Color(0xff1f1f1f),),
                                                            Padding(
                                                              padding: const EdgeInsets.all(8.0),
                                                              child: Text("Download Sample Synopsis",style: TextStyle(color: Color(0xff1f1f1f)),),
                                                            ),
                                                          ],
                                                        ),
                                                      ))),),
            ...
            : (progressindicatorvariable)
                ? Scaffold(
                    body: Center(
                      child: Container(child:SpinKitWave(color: Color(0xffefb168) ,type: SpinKitWaveType.start,)),
                    ),
                  )
                : Scaffold(
                  
                    body: Container(decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/bgapp.jpg",),fit: BoxFit.fitWidth)),
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            loginclicked
                                ? Container()
                                :   Padding(padding: EdgeInsets.only(bottom: 30,top:30),child: Image.asset("assets/gg.png"),),
                            ...
                            loginclicked
                                ? Container()
                                : GestureDetector(
                                    child: Card(color:Color(0xffefb168),child: Container(height:40,width: MediaQuery.of(context).size.width-150,child: Center(child: Text("Login",style: TextStyle(color: Color(0xff1f1f1f),fontSize: 15,fontWeight: FontWeight.bold),)))),
                                    onTap: () {
                                      setState(() {
                                        loginclicked = true;
                                      });
                                    ...
                                    child: Padding(
                                      ...
                                      child: Card(color: Color(0xff1f1f1f),elevation: 20,
                                          ...
                                          child: Column(
                                            ...
                                            GestureDetector(onTap: (){
                                            ...
                                            },child:  Align(alignment: Alignment.topLeft,child: Icon(Icons.arrow_back,color: Color(0xffefb168),),),),
                                              Padding(padding: EdgeInsets.only(bottom: 30,top:30),child: Image.asset("assets/gg.png"),),
                                              Padding(
                                              ...
                                              GestureDetector(onTap: (){
                                                ...
                                                if(scrollsId.isEmpty||email.isEmpty||password.isEmpty)
                                                  _displaySnackBar(context, "Please Fill all the entries");
                                                  else
                                                  if(!RegExp(r"^[a-zA-Z0-9.]+@[a-zA-Z0-9]+\.[a-zA-Z]+").hasMatch(email))
                                                   _displaySnackBar(context, "Please enter a valid email");
                                                  else
                                                loginFunction();
                                                print(scrollsId);
                                                print(password);
                                                ...
                                                child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                                  children: <Widget>[
                                                    Icon(Icons.person,color: Color(0xff1f1f1f),),
                                                    Padding(
                                                      padding: const EdgeInsets.all(8.0),
                                                      child: Text("Log-in",style: TextStyle(color: Color(0xff1f1f1f)),),
                                                    ),
                                                  ],
                                                ),
                                              ))),),
                            ...
                            loginclicked
                                ? Container()
                                : GestureDetector(
                                    child: Card(color:Color(0xffefb168),child: Container(height:40,width: MediaQuery.of(context).size.width-150,child: Center(child: Text("Register",style: TextStyle(color: Color(0xff1f1f1f),fontSize: 15,fontWeight: FontWeight.bold),)))),
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
