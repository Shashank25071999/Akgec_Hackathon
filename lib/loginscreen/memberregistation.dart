...
class MemberRegistationtateState extends State<MemberRegistation> {
  MemberRegistationtateState(this.token,this.scrollsid,this.teamid,this.email);
  var email;
  var token;
  var teamid;
  var scrollsid;
  ...
  Future<void> registation() async {
    ...
    http.post("https://scrolls19-backend.herokuapp.com/api/register/member", body: json.encode(memberdata), headers: {
                        ...
                        child: Center(
                          child: RaisedButton(
                            ...
                            onPressed: () {
                              ...
                              print(lastname);
                              if(firstname.isEmpty||lastname.isEmpty||college.toString().isEmpty||mobilenumber.isEmpty||password.isEmpty||confirmpassword.isEmpty)
                                {_displaySnackBar(context, "Please fill all the Details");
                  
                                }else if(password.compareTo(confirmpassword)!=0)
                                 {_displaySnackBar(context, "Entered Passwords do not match");
                                 }else if(password.length<8)
                                  {_displaySnackBar(context, "Password too short");
                                  }else if(mobilenumber.length!=10)
                                   {_displaySnackBar(context, "Enter a valid mobile no.");
                                   }else
                                  {registation();}
